...
namespace Implement.Migrations
{
    ...
    partial class CasinoMassProgramDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Implement.EntityModels.AwardSettlement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Implement.EntityModels.ImportBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Implement.EntityModels.ImportCellError", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Implement.EntityModels.ImportRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Implement.EntityModels.Member", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Implement.EntityModels.TeamRepresentative", b =>
                {
                    ...
                    b.Property<string>("TeamRepresentativeId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("TeamRepresentativeName")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("Implement.EntityModels.AwardSettlement", b =>
                {
                    b.HasOne("Implement.EntityModels.Member", "Member")
                        .WithMany()
            ...
            modelBuilder.Entity("Implement.EntityModels.ImportCellError", b =>
                {
                    b.HasOne("Implement.EntityModels.ImportRow", "Row")
                        .WithMany("Errors")
                        .HasForeignKey("RowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Implement.EntityModels.ImportRow", b =>
                {
                    b.HasOne("Implement.EntityModels.ImportBatch", "Batch")
                        .WithMany("Rows")
